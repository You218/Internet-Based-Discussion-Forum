# Internet-Based-Discussion-Forum-main
A discussion forum wesbite built with Html,CSS,Javascript and Djang0 as an backend with sqlite database is an an online discussion site where people can post questions, possts and interract with other users.
